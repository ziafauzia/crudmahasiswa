                    ...
                    <div class="card">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= set_value('namaprodi'); ?>" name="namaprodi" class="form-control" id="namaprodi" placeholder="nama prodi">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= set_value('namakaprodi'); ?>" name="namakaprodi" class="form-control" id="namakaprodi" placeholder="nama kaprodi">
                                    <?= form_error('namakaprodi', '<small class="text-danger p1-3">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="tahunberdiri">Tahun Berdiri</label>
                                    <input type="text" value="<?= set_value('tahunberdiri'); ?>" name="tahunberdiri" class="form-control" id="tahunberdiri" placeholder="tahun berdiri">
                                    <?= form_error('tahunberdiri', '<small class="text-danger p1-3">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="outputlulusan">Output Lulusan</label>
                                    <input type="text" value="<?= set_value('outputlulusan'); ?>" name="outputlulusan" class="form-control" id="outputlulusan" placeholder="Output Lulusan">
